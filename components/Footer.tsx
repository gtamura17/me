  ...
  return (
    <footer className="bg-dark-900 text-white py-12">
      <div className="container-max section-padding">
        ...
        >
          <div className="mb-8">
            <h3 className="text-2xl font-bold mb-2">{currentProfileData.name}</h3>
            <p className="text-gray-400">{currentProfileData.title}</p>
          </div>
          ...
          <div className="border-t border-gray-800 pt-8">
            <p className="text-gray-400 text-sm">
              © {currentYear} {currentProfileData.name}. {t('footer.madeWith')}{' '}
              <Heart className="inline w-4 h-4 text-red-500" /> {t('footer.by')}{' '}
