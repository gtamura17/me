        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            ...
            >
              ...
              <p className="text-gray-600">Desenvolvendo soluções web modernas e escaláveis</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Projetos Concluídos</h3>
              <p className="text-gray-600">Diversos projetos para clientes e pessoais</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Tecnologias</h3>
              <p className="text-gray-600">Domínio em diversas tecnologias modernas</p>
            </motion.div>
          </div>
        </motion.div>
      </div>
